...
import (
	...
	"github.com/klaytn/klaytn-load-tester/contracts/blockbench/ioHeavyTC"
...
func deployContract(coinbase *account.Account) {
	...
	for {
		var err error
		address, tx, gIOHeavy, err = ioHeavyTC.DeployIOHeavy(auth, conn)
		if err == nil {
