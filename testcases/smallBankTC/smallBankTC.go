...
import (
	...
	"github.com/klaytn/klaytn-load-tester/contracts/blockbench/smallBankTC"
...
var (
	...
	gSmallBank *smallBankTC.SmallBank
...
func deployContract(coinbase *account.Account) {
	...
	for {
		var err error
		address, tx, gSmallBank, err = smallBankTC.DeploySmallBank(auth, conn)
		if err == nil {
