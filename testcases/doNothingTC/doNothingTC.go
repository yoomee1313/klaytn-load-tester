...
import (
	...
	"github.com/klaytn/klaytn-load-tester/contracts/blockbench/doNothingTC"
...
var (
	...
	gDoNothing *doNothingTC.DoNothing
)
...
func deployContract(coinbase *account.Account) {
	...
	for {
		var err error
		address, tx, gDoNothing, err = doNothingTC.DeployDoNothing(auth, conn)
		if err == nil {
