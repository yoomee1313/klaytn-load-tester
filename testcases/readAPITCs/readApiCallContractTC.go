...
import (
	...
	"github.com/klaytn/klaytn-load-tester/contracts/readApiCallContractTC"
	"log"
	"math/big"
	"math/rand"
	"strconv"
...
var (
	...
	readApiCallContract *readApiCallContractTC.ReadApiCallContract
...
func deployContract(coinbase *account.Account, endPoint string) {
	...
	for {
		var err error
		contractAddr, tx, readApiCallContract, err = readApiCallContractTC.DeployReadApiCallContract(auth, conn)
		if err == nil {
